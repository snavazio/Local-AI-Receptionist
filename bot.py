...
# Domain config (business facts, persona, tool schemas, system prompt) is
# loaded from config/<domain>.yaml. Set DOMAIN_CONFIG env var to point at a
# different file to drive a non-dental bot without touching this file.
from config.loader import (
    PRACTICE, GREETING, SYSTEM_PROMPT, TOOLS as _TOOLS_OPENAI, make_pipecat_tools_schema,
)
...
# Tool schemas come from config/<domain>.yaml. The loader builds a Pipecat
# ToolsSchema we can register with the LLM service.
tools = make_pipecat_tools_schema()
